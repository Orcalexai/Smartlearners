...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="py-12 bg-gradient-to-br from-purple-200 via-pink-200 to-blue-200">
      ...
      <section className="py-8 bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 relative overflow-hidden">
