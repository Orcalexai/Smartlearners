...
export const metadata: Metadata = {
  ...
  description: 'Discover Smart Learners.ai\'s innovative features: AI-powered personalization, smart gap analysis, instant feedback, adaptive learning paths, and achievement certificates for CBSE students.',
